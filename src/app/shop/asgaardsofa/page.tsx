          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <ul>
              ...
              <li className="text-sm text-gray-600 flex gap-3">
                ...
                <Link href="#" className="social-btn twi">
                  t
                </Link>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-bold">Rs. 60,000.00</p>
            </div>
            <div className="text-center">
              <Image
                ...
                className="object-contain mx-auto"
              />
              <h3 className="text-sm font-semibold mt-2">Jacques end table</h3>
            ...
            <div className="text-center">
              <Image
                ...
                className="object-contain mx-auto"
              />
              <h3 className="text-sm font-semibold mt-2">Grange dining chair</h3>
              <p className="text-lg font-bold">Rs. 22,000.00</p>
            </div>
          </div>
        </div>
      </section>
